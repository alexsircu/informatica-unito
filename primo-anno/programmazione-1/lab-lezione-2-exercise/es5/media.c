...
int main(void) {
	...
	// 1) media3 double perchè si divide per 3.0
	// 2) media3 double perchè numeratore dopo il calcolo in parentesi viene castato a double
	// 3) media3 double viene fatto sul risultato della divisione
	...
	// 1) cast da double a int e viene troncata la parte dopo la virgola
	// 2) arrotondamento sempre a numero intero più piccolo
	// 3) arrotondamento tradizionale con .5 all'intero superiore e sotto .5 all'intero inferiore
	// 4) arrotondamento al numero intero superiore, anche per quelli minori di 0
	...
	// Perchè i numeri floating point in C non possono essere rappresentati esattamente in binario
	// a causa della precisione limitata dei tipi double o float.
}
