...
int main(void) {
	...
	// Le dimensioni dei tipi puntatore sono di 8 byte perchè 1 puntatore è un indirizzo
	// di memoria e ogni indirizzo di memoria, in questa macchina, è di 8 byte.

    // Un tipo senza segno molto importante e': size_t
    // l'operatore sizeof() ritorna un valore in byte con tipo size_t
    int n = 100;
